...
export default {
  'Avada Kedavra': new Spell('Avada Kedavra', 2, 4, Spell.TYPE_DARK, 4, 3, 'Combat Spell. If successful, target model is removed from play, ignoring all normal Damage rules.'),
  ...
  'Crucio': new Spell('Crucio', 1, 3, Spell.TYPE_DARK, 4, 2, 'Combat Spell. If successful, target model suffers 2 Magical Damage', true, 1),
  ...
  'Obliviate': new Spell('Obliviate', 3, 1, Spell.TYPE_MIXED, 4, 1, 'Target model increases the Difficulty of the next Challenge it is invovled in by 2.'),
